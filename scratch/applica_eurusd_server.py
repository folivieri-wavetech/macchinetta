...
def aggiorna():
    ...
    for acc in accounts:
        ...
        c_m5 = []
        c_path = f'/data/{acc}/candele_EUR_USD_MINUTE_5.json'
        ...
        print(f"[OK] {acc}: memoria_parametri.json aggiornata con EUR/USD (totale {len(mem)} strumenti).")
        
        for tf in ['MINUTE_5', 'HOUR', 'HOUR_4', 'DAY']:
            old_f = f'/data/{acc}/candele_AUD_CAD_{tf}.json'
